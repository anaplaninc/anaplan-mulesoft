    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((AnaplanConnector) object).myProcessor(_transformedContent);
                }
    ...
    public Result<MetaData> getGenericMetaData(MetaDataKey metaDataKey) {
        ...
        try {
            connector = ((ConnectorMetaDataEnabled) findOrCreate(AnaplanConnectorConnectionManager.class, true, null));
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at AnaplanConnector at myProcessor retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
